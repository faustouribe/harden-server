...
# Install Extip
sudo wget https://github.com/arsham/figurine/releases/download/v1.3.0/figurine_linux_amd64_v1.3.0.tar.gz && tar -xvf figurine_linux_amd64_v1.3.0.tar.gz \
&& cd deploy && sudo mv figurine /usr/bin/ && cd ../ && sudo rmdir deploy && sudo chmod +x /usr/bin/figurine \
